...
export default function StudentLayout({
  ...
  return (
    <AuthWrapper requiredRole="student" fallbackPath="/">
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              <div className="flex-shrink-0 flex items-center px-4">
                <h1 className="text-xl font-bold text-primary-600">Hedefly Öğrenci</h1>
              </div>
            ...
            <div className="flex-shrink-0 flex border-t border-secondary-200 p-4">
              <div className="flex items-center w-full">
                <div className="ml-3 flex-1">
                  ...
                  <p className="text-sm font-medium text-secondary-500">Öğrenci</p>
                </div>
                <button
